    ...
    <article>
        ...
        <aside>
            ...
            <form>
                ...
                <p>邮箱地址请按要求格式输入</p>
                <p>请输入密码: <input type="text" placeholder="这是一个文本输入框" pattern="[A-Za-z]{6,16}">请重复输入密码: <input type="text" placeholder="这是一个文本输入框" pattern="[A-Za-z]{6,16}"></p>
                <p>密码请为6-16位英文数字</p>
